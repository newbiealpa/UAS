...
<body>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10 text-center">
            <p class="lead text-light">
              ...
              ini bertanggung jawab untuk pengembangan, pemeliharaan, dan pengoptimalan website resmi SIRIL Community
              serta memberikan materi yang berkaitan dengan Web Development.

              Program kinerja di divisi website mencakup beberapa inisiatif yang bertujuan untuk meningkatkan kualitas
              layanan dan pengalaman anggota. Salah satunya adalah pengembangan konten informatif dan edukatif tentang
              teknologi, baik melalui artikel, tutorial, maupun sumber daya belajar lainnya. Dengan demikian, website
              menjadi sumber referensi yang berharga bagi mahasiswa IT dan masyarakat umum yang tertarik dengan
  ...
  <section id="instructors" class="p-5 bg-primary" style="background-image: linear-gradient( black, rgb(255, 208, 0))">
    <div class="container">
